...
function seedCambridgeListeningTest1() {
    var _a;
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const existing = yield questionSet_model_1.QuestionSet.findOne({ setType: "LISTENING", setNumber: 2 });
            if (existing) {
            ...
            const adminUser = yield db.collection("users").findOne({ role: "admin" });
            const createdBy = (adminUser === null || adminUser === void 0 ? void 0 : adminUser._id) || new mongoose_1.default.Types.ObjectId();
            ...
            const newSet = yield questionSet_model_1.QuestionSet.create(cambridgeListening1);
            ...
            console.log("Total Sections:", (_a = newSet.sections) === null || _a === void 0 ? void 0 : _a.length);
            console.log("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━");
